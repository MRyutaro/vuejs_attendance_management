<template>
<div class="flex h-screen w-full items-center justify-center bg-stone-300 bg-cover bg-no-repeat">
    <div class="text-black">
      ...
      <form action="#">
        <div class="mb-4 text-lg">
          <input class="rounded-4xl border-none bg-white-400 bg-opacity-50 px-6 py-2 text-center text-inherit placeholder-slate-200 shadow-lg outline-none backdrop-blur-md" type="text" name="name" placeholder="Email or Username" />
        </div>
        <div class="mb-4 text-lg">
        ...
        <a href="" class="text-sm text-rigth font-semibold text-blue-500">Sing up</a>
        </div>
      </form>
    </div>
  </div>
